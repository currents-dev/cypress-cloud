import { createRun, CreateRunResponse } from "estefafdez-cloud/lib/api";
import { getAPIBaseUrl } from "estefafdez-cloud/lib/httpClient/config";
import nock from "nock";
import { printWarnings } from "../warnings";
import { createRunPayload, createRunResponse } from "./fixtures/run";

jest.mock("../warnings");
jest.mock("estefafdez-cloud/lib/httpClient/config", () => ({
